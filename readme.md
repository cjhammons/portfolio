...
## Data Science
  ...
  - [Sentiment Analysis using a Neural Network](projects/report.html): Using review data from multiple sources, trained a Neural Network with TensorFlow to generally classify positive or negative sentiment. 
